...
switch($_SESSION['locale'])
{
	...
	case '8':
		mass_define(array(
			...
			'LOCALE_GBONUS_EXPENDABLE'					=>	'расходуется',
			'LOCALE_COOLDOWN'					=>	'кулдаун',
	...
	case '3':
		mass_define(array(
			...
			'LOCALE_QUEST_FLAGS_STAY_ALIVE'			=> '[Es muss am Leben geblieben werden]',
			'LOCALE_QUEST_FLAGS_PARTY_ACCEPT'		=> '[Suggested to all party members]',
			'LOCALE_QUEST_FLAGS_EXPLORATION'		=> '[Exploration related]',
			'LOCALE_QUEST_FLAGS_SHARABLE'			=> '[Teilbar]',
			'LOCALE_QUEST_FLAGS_EPIC'				=> '[Episch]',
			'LOCALE_QUEST_FLAGS_RAID'				=> '[Raid]',
			'LOCALE_QUEST_FLAGS_TBC'				=> '[The Burning Crusade benötigt]',
			'LOCALE_QUEST_FLAGS_UNK2'				=> '[Weitere Items benutzt]',
			'LOCALE_QUEST_FLAGS_HIDDEN_REWARDS'		=> '[Belohnungen werden erst bei Abschluss angezeigt]',
			'LOCALE_QUEST_FLAGS_AUTO_REWARDED'		=> '[Automatisch fertig und belohnt]',
			'LOCALE_QUEST_FLAGS_TBC_RACES'			=> '[Blutelfen/Draenei Standort]',
			'LOCALE_QUEST_FLAGS_DAILY'				=> '[Täglich]',
			'LOCALE_QUEST_FLAGS_UNK5'				=> '[PvP]',
			'LOCALE_QUEST_SPECIALFLAGS_REPEATABLE'	=> '[Wiederholbar]',
			'LOCALE_QUEST_SPECIALFLAGS_SCRIPTED'	=> '[Wird nur von script/event beendet]',
			'LOCALE_QUEST_HAS_POI'					=> '[Hat interessante Markierungen]',
			'LOCALE_QUEST_HAS_START_SCRIPT'			=> '[Hat ein Startscript]',
			'LOCALE_QUEST_HAS_COMPLETE_SCRIPT'		=> '[Hat ein Endscript]',
			'LOCALE_QUEST_TYPE_GROUP'				=> '[Gruppe]',
			'LOCALE_QUEST_TYPE_LIFE'				=> '[Leben]',
			'LOCALE_QUEST_TYPE_PVP'					=> '[PvP]',
			'LOCALE_QUEST_TYPE_RAID'				=> '[Raid]',
			'LOCALE_QUEST_TYPE_DUNGEON'				=> '[Dungeon]',
			'LOCALE_QUEST_TYPE_WORLD_EVENT'			=> '[Welt Event]',
			'LOCALE_QUEST_TYPE_LEGENDARY'			=> '[Legendär]',
			'LOCALE_QUEST_TYPE_ESCORT'				=> '[Begleiten]',
			'LOCALE_QUEST_TYPE_HEROIC'				=> '[Heroisch]',
